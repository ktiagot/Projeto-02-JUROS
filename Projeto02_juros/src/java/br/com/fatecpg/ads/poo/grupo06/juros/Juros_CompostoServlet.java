            ...
            +"<div class='container'>"
                ...
                +"<div class='collapse navbar-collapse navbar-right'>"
                    +"<ul class='nav navbar-nav'>"
                        ...
                        +"<li><a href='br.com.fatecpg.ads.poo.grupo06.juros/Juros_SimplesServlet.Java'>Juros Simples</a></li>"
                        +"<li><a href='br.com.fatecpg.ads.poo.grupo06.juros/Juros_CompostoServlet.Java'>Juros Compostos</a></li>"
                    +"</ul>"
                +"</div>"
            +"</div><!--/.container-->"
        +"</nav><!--/nav-->		"
